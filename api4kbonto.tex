...
%
%\begin{enumerate}
%\item What are the entities that are communicating in the %distributed API4KB system?
%\item How do they communicate, or, more specifically, what communication paradigm is used between API4KB entities?
%\item What (potentially changing) roles and responsibilities do they have in the overall API4KB architecture?
...
In DOL  \todo{cite DOL}, a concept of language environment is developed \todo{quote definition of environment from DOL}
...
%                otherwise, the value is obtained by lifting x into Right[Right] by applying a full functor G that is a right adjoint of the forgetful functor F from M2 to M1
