...
A Clinical Decision Support System (CDS), implemented using event-condition-action (ECA) rules, will also react to events simple (e.g. a vital parameter exceeding a threshold) and complex \todo{FIXME cite some CEP? keep examples?} (e.g. a decreasing trend in the average daily physical activity) and intervene with alerts and reminders. 
...
% FIXME Do RPC and RMI need to be defined?
...
%FIXME Tara/Davide/Adrian don't create false expectations
% 
...
%FIXME Tara change Tree to Nested
