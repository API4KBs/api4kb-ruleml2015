...
%In general, a biased disjunction (Either) of monads instances of the same generic type can serve as a basis for tree structures as follows: 
...
The Kleisli Query System \todo{ cite \url{http://homepages.inf.ed.ac.uk/wadler/realworld/kleisli.html}} has implemented a similar approach for data computations.
